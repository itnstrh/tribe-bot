...
TEXTS = {
    "uk": {
        ...
        "courage": (
            ...
            "Можеш, будь ласка, розповісти кружечком про себе і свої запити/страхи? "
            "(Це твій перший виклик, але якщо дуже ніяково — можеш текстом або аудіо)"
        ),
    ...
    "ru": {
        ...
        "apply_individual_button": "хочу",
        "courage": (
            "Рад твоей смелости идти на страх. Можешь, пожалуйста, рассказать "
            "кружочком о себе и своих запросах/страхах? (Это твой первый вызов, "
            "но если сильно неловко — можешь текстом или аудио)"
        ),
